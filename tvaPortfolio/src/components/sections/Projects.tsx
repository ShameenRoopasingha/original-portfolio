            ...
            <div className="projects-grid" style={{
                ...
                <aside className="projects-sidebar" style={{
                    ...
                    <div className="custom-scrollbar" style={{
                        ...
                        paddingRight: '10px',
                        marginRight: '-10px',
                        minHeight: 0, // Ensure flex child can shrink and scroll
                    }}>
        ...
        >
                ...
                <div style={{ paddingTop: '15px' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        <div style={{
                            ...
                            height: '6px',
                            borderRadius: '50%',
                            background: project.inDevelopment ? '#FF3333' : '#00FF00',
                            boxShadow: project.inDevelopment ? '0 0 8px #FF3333' : '0 0 8px #00FF00',
                        }} />
                        <span style={{
                            fontSize: '11px',
                            textTransform: 'uppercase',
                            letterSpacing: '0.12em',
                            color: project.inDevelopment ? '#FF3333' : '#00FF00',
                        }}>
                            {project.inDevelopment ? 'CAUTION • IN DEVELOPMENT' : 'Declassified • Authenticated'}
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div style={{
                ...
                {project.demoUrl ? (
                    ...
                    <ActionButton primary disabled>View Live Demo</ActionButton>
                )}
